...
// require Facebook OAuth2 strategy
const FacebookStrategy = require('passport-facebook').Strategy;


// require findOrCreate function from npm package - function create to find users in DB, and to create user if there is no one
